...
<DropdownMenuContent
  align="end"
  sideOffset={8}
  className="w-56 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-[9999]"
>

    <DropdownMenuItem onClick={() => onNavigate('profile')} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-gray-50">
    ...
    <DropdownMenuItem onClick={handleLogout} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-red-600 hover:bg-red-50">
