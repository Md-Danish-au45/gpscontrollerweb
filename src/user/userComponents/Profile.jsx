...
import {
    MoreVertical, Bell, Edit3, Check, X, User, Mail, ShieldCheck, AlertTriangle, CreditCard,
    Activity, Shield, Award, Settings, Phone, CheckCircle, XCircle, Crown, Upload, Loader2, LogOut
} from "lucide-react"
...
export default function Profile() {
    ...
    return (
        <>
            ...
            <div className="space-y-4 md:hidden px-4 pt-6">
                <h3 className="text-xl font-bold text-gray-900">Account Actions</h3>
                <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
                    <Button
                        variant="outline"
                        className="flex-col h-24 border-gray-200"
                        onClick={() => navigate('/user', { state: { view: 'verification-results' } })}
                    >
                        <ShieldCheck className="w-6 h-6 mb-1 text-blue-600" />
                        <span className="text-sm">Results</span>
                    </Button>
                    <Button
                        variant="outline"
                        className="flex-col h-24 border-gray-200"
                        onClick={() => navigate('/user', { state: { view: 'history' } })}
                    >
                        <Activity className="w-6 h-6 mb-1 text-green-600" />
                        <span className="text-sm">History</span>
                    </Button>
                    <Button
                        variant="outline"
                        className="flex-col h-24 border-gray-200 text-red-600 hover:bg-red-50 hover:text-red-700"
