...
export default function DashboardHeader({ sidebarOpen, setSidebarOpen }) {
    ...
    <header className="fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-lg border-b border-gray-100/50 px-4 py-3 md:px-6 md:py-4 shadow-sm">
      <div className="flex items-center justify-between h-full">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          >
            <img src={VerifyMyKyc  || sidebarLogo} alt="Logo" className="h-12 w-auto" />
          </div>
  ...
  <DropdownMenu>
<DropdownMenuTrigger>
  <Button variant="ghost" className="h-9 px-2 flex items-center gap-2 rounded-full hover:bg-gray-100">
...
<DropdownMenuContent
  align="end"
  sideOffset={8}
  className="z-[9999] w-48 bg-white rounded-xl shadow-lg border border-gray-200 py-2"
>
