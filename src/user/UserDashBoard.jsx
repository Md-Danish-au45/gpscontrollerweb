...
// renderContent function - receives categoryFilter and setActiveView for services view
const renderContent = (activeView, services, pricingPlans, isLoading, userInfo, transactions, categoryFilter, setActiveView) => {
  switch (activeView) {
    case "dashboard":
    ...
    case "services":
      ...
      return <ServiceCardsViewer services={services} pricingPlans={pricingPlans} isLoading={isLoading} userInfo={userInfo} selectedCategory={categoryFilter} onNavigateToVerificationHistory={() => setActiveView("verification_history")} />;
    case "history":
...
export default function UserDashBoard() {
  ...
  // Filtering is handled inside ServiceCardsViewer now
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 mt-16">
          ...
          >
            {isLoading ? (
              ...
              renderContent(activeView, services, pricingPlans, isLoading, userInfo, transactions, categoryFilter, setActiveView)
            )}
          </div>
        </main>
      </div>
