          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg leading-relaxed text-gray-700">
                As Founder and Chief Executive Officer of Bringmar, Md Danish is responsible for the vision and the global planning with business strategies in place at Verify E-KYC. An expert at raising and mentoring teams and making them successful, Danish being an effective leader has continually diversified its solution offerings and promised to take Md Danish to the forefront of the global outsourcing industry.
              </p>
            </div>
          </motion.div>
        </div>
